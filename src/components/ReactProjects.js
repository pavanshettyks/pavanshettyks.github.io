        ...
        <div className="project-grids">
                    <Grid> 
                        ...
                        <Card shadow={4} style={{ margin: 'auto'}}>
                             <CardTitle style={{color: '#fff', height: '160px', background: `url(${LogoReact}) center / cover`}}>Time Table Scheduler</CardTitle>
                            <CardText>
                        ...
                        <Cell col={4}> 
                        <Card shadow={4} style={{ margin: 'auto'}}>
                             <CardTitle style={{color: '#fff', height: '160px', background: `url(${LogoReact}) center / cover`}}>Portfolio Site</CardTitle>
                            <CardText>
                        ...
                        <Cell col={4}> 
                        <Card shadow={4} style={{ margin: 'auto'}}>
                             <CardTitle style={{color: '#fff', height: '160px', background: `url(${LogoReact}) center / cover`}}>Simple Inventory Manager</CardTitle>
                            <CardText>
                        ...
                        <Cell col={4}> 
                        <Card shadow={4} style={{ margin: 'auto'}}>
                             <CardTitle style={{color: '#fff', height: '160px', background: `url(${LogoReact}) center / cover`}}>To Do List</CardTitle>
                            <CardText>
